...
class Prosodia_module():
    def __init__(self):
        ...
        logging.info("Prosodia model initialized.")
        self.model.load_state_dict(torch.load(model_path, map_location=self.device))
        self.model.to(self.device)
        logging.info("Prosodia model loaded from %s.", model_path)
    ...
    def obtener_indices_prosodia(self, words_array):
        """
        obtenemos el indice de prosodai de cada palabra dentro de words_array
        """
        ...
        print("predicted_indices_all_tokens",predicted_indices_all_tokens)
        prosodic_tags = []
        prosodic_pauses=[]
